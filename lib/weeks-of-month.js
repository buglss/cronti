 ...
 */
module.exports = function({ firstDayOfWeek = 1, month, year = new Date().getFullYear(), parse = false, fill = true }) {
    ...
    let weeks = []
    let firstDay = dayOfWeek(new Date(year, month, 1), { firstDayOfWeek })
