...
[Demo project download (rar)](blob/v1.0.9/demo/publish/demo.rar?raw=true). Extract the project files from rar. Go to project directory. Execute ``index.js`` file by **nodejs**.
